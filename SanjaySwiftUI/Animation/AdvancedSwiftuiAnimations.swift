...
struct AdvancedSwiftuiAnimations: View {
...
struct Example5: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack(spacing: 20) {
                MyButton(label: "9:51:10", font: .footnote, textColor: .black) {
                    self.duration = 2.0
                    self.time = ClockTime(9, 51, 10)
                }
                ...
                MyButton(label: "10:00:01", font: .footnote, textColor: .black) {
                    self.duration = 4.0
                    self.time = ClockTime(10, 00, 01)
                }
...
struct RotatingCard: View {
    ...
    var body: some View {
        ...
        return VStack {
            Spacer()
            Image(flipped ? "cards-BK" : images[imgIndex]).resizable()
