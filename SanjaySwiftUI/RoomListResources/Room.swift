...
let testData = [
    ...
    Room(name: "Yellow Matrix", building: "D", floor: "3", capacity: 1, hasVideo: false, imageName: "room09", coordinates: Coordinates(latitude: 56.948889, longitude: 24.106389), annotaionItemPlaces: [
        ...
        SSAnnotaionItemPlace(name: "Kozy Eats", latitude: 56.951924, longitude: 24.125584),
        SSAnnotaionItemPlace(name: "Green Pumpkin", latitude:  56.967520, longitude: 24.105760),
        SSAnnotaionItemPlace(name: "Terapija", latitude: 56.9539906, longitude: 24.1364929)
    ], mapZoomLevel : 0.10
    )
]
