...
let mainMenuData = [
    ...
    SSMenuItem( title: "SF Symbols Demo", systemImage1: "square.on.square.squareshape.controlhandles", systemImage2: "", isGroupEnd: false, destination: AnyView( SSSFSymbolSwiftUIView() ) ),
