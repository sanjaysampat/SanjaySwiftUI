...
extension SSPhotoEditorViewController {
...
extension SSPhotoEditorViewController: StickersViewControllerDelegate {
    ...
    func addGestures(view: UIView) {
        ...
        let panGesture = UIPanGestureRecognizer(target: self,
                                                action: #selector(SSPhotoEditorViewController.panGesture))
        ...
        let pinchGesture = UIPinchGestureRecognizer(target: self,
                                                    action: #selector(SSPhotoEditorViewController.pinchGesture))
        pinchGesture.delegate = self
        view.addGestureRecognizer(pinchGesture)
        
        let rotationGestureRecognizer = UIRotationGestureRecognizer(target: self,
                                                                    action:#selector(SSPhotoEditorViewController.rotationGesture) )
        rotationGestureRecognizer.delegate = self
        view.addGestureRecognizer(rotationGestureRecognizer)
        
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(SSPhotoEditorViewController.tapGesture))
