...
extension SSPhotoEditorMainViewController {
    ...
    // SSTODO we may create a new imageview like stickerview and add it to
    // canvasimageview like others. The size of it will always be like
    // canvasimageview. Then in drawLineFrom use this new imageview
    // instead of 'canvasImageView.image?.draw'
    // we have to find way to delete this view. ????
    ...
    override public func touchesBegan(_ touches: Set<UITouch>,
        ...
        if isDrawing {
            ...
            if let touch = touches.first {
                ...
                if !ssstickersViewController.view.frame.contains(location) {
                    removeStickersView()
                }
            }
        }
