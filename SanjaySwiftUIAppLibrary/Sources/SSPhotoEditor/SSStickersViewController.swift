//
//  SSStickersViewController.swift
//  Photo Editor
//
...
@objcMembers class SSStickersViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    var ssstickersViewControllerDelegate : SSStickersViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        let gesture = UIPanGestureRecognizer.init(target: self, action: #selector(SSStickersViewController.panGesture))
    ...
    func configureCollectionViews() {
        ...
        collectioView.register(
            UINib(nibName: "SSStickerCollectionViewCell", bundle: Bundle.module),
            forCellWithReuseIdentifier: "SSStickerCollectionViewCell")
        ...
        emojisDelegate.ssstickersViewControllerDelegate = ssstickersViewControllerDelegate
        emojisCollectioView.delegate = emojisDelegate
        emojisCollectioView.dataSource = emojisDelegate
        
        emojisCollectioView.register(
            UINib(nibName: "SSEmojiCollectionViewCell", bundle: Bundle.module),
            forCellWithReuseIdentifier: "SSEmojiCollectionViewCell")
    ...
    func removeBottomSheetView() {
        UIView.animate(withDuration: 0.3,
            ...
            self.ssstickersViewControllerDelegate?.stickersViewDidDisappear()
        })
    }
...
extension SSStickersViewController: UIScrollViewDelegate {
...
extension SSStickersViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ssstickersViewControllerDelegate?.didSelectImage(image: stickers[indexPath.item])
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let identifier = "SSStickerCollectionViewCell"
        let cell  = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! SSStickerCollectionViewCell
